...
TABLE_CONFIGS: Dict[str, TableConfig] = {
    "report.vw_regras_diarias_taxas_historico": TableConfig(
        ...
        business_key=["contrato_id", "contrato_nome_prestador", "contrato_nome_operadora", "Escopo", "Hierarquia", "Subclassificação Diárias / Taxas", TIPO_DE_PLANO, "Categoria de plano", "Tipo de acomodação", TIPO_DE_ATENDIMENTO, "Principais itens de transposição", "Outros itens de transposição"],
    ...
    "report.vw_regras_hm_sadt_historico": TableConfig(
        ...
        business_key=["contrato_id", "contrato_nome_prestador", "contrato_nome_operadora", "Escopo", "Hierarquia", "Subclassificação HM/SADT", TIPO_DE_PLANO, "Categoria de plano", "Tipo de acomodação", "Especialidades HM/SADT", TIPO_DE_ATENDIMENTO],
    ...
    "report.vw_regras_pacotes_historico": TableConfig(
        ...
        business_key=["contrato_id", "contrato_nome_prestador", "contrato_nome_operadora", "Escopo", "Hierarquia", "Subclassificação Pacotes", TIPO_DE_PLANO, "Categoria de plano", "Tipo de acomodação", TIPO_DE_ATENDIMENTO],
